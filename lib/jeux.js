...
var chainer = function chainer(starter, middleware) {
  var args = [starter].concat(_toConsumableArray(middleware));
  var functions = [];
...
var _updateStateFromReducers = __webpack_require__(/*! ./updateStateFromReducers.js */ "./src/updateStateFromReducers.js");

var _updateStateFromReducers2 = _interopRequireDefault(_updateStateFromReducers);
...
function createStore(reducers) {
  ...
  (0, _updateStateFromReducers2["default"])(state, reducers, reducerKeys, undefined);
  ...
  function dispatch(action) {
    ...
    var stateHasChanged = (0, _updateStateFromReducers2["default"])(state, reducers, reducerKeys, action);
...
/***/ "./src/updateStateFromReducers.js":
/*!****************************************!*\
  !*** ./src/updateStateFromReducers.js ***!
  \****************************************/
/*! no static exports found */
...
function updateStateFromReducers(state, reducers, reducerKeys, action) {
  ...
  for (var i = 0; i < reducerKeys.length; i += 1) {
    ...
    var previousState = state[reducerKey];
    var nextState = reducer(state[reducerKey], injectedAction);
...
exports["default"] = updateStateFromReducers;
